CREATE TYPE public.app_role AS ENUM ('admin', 'oficial', 'sentinela');
...
AS $$
BEGIN
  INSERT INTO public.profiles (id, nome, email, posto)
  VALUES (
    NEW.id,
  ...
  VALUES (
    NEW.id,
    COALESCE((NEW.raw_user_meta_data ->> 'role')::public.app_role, 'sentinela')
  )
